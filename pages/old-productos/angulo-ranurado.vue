<template>
  <section class="text-gray-600 body-font overflow-hidden">
    <div class="container p-5 mx-auto">
      <Breadcrumbs :breadcrumbs="[{label: 'Ángulo Ranurado'}]" />
    </div>
  </section>
  <section class="text-gray-600 body-font overflow-hidden">
    <div class="container px-5 py-10 mx-auto">
      <div class="lg:w-4/5 mx-auto flex flex-wrap">
        ...
        <div class="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
          <h2 class="text-sm title-font text-gray-500 tracking-widest">TIPO DE CARGA: MANUAL, PICKING</h2>
          <h1 class="text-gray-900 text-3xl title-font font-medium mb-1">ÁNGULO RANURADO</h1>
          
          <p class="leading-relaxed text-justify pt-3">Solución para almacenaje de productos livianos y de menor tamaño. Utilizado principalmente en bodegas para almacenar repuestos, 
            prendas de vestir y archivos. Un producto totalmente mecano y adaptable a los espacios disponibles, permitiendo lograr un aprovechamiento optimo y eficiente. 
            <br>Nuestras Estanterías son diseñadas a medida estándares adaptables a los espacios disponibles, según las necesidades del cliente, y cumplen con todas las normas 
            Chilenas antisísmicas, para brindar la mayor seguridad en el almacenaje de sus productos.
          </p>
          <h3 class="text-2xl text-black py-3">Ventajas de las Estanterías en Ángulo Ranurado</h3>
          <ul class="list-disc pl-10">
            <li>Mejor control de Inventario de los productos</li>
            <li>Utilización eficiente de la altura</li>
            <li>Diseñado con el mas alto estándar antisismico.</li>
            <li>Acceso directo a cada producto</li>
            <li>Adaptable y Modificable</li>
          </ul>
          <div class="mt-10">
  ...
  <section class="text-gray-600 body-font">
    <div class="container px-5 py-24 mx-auto">
      <div class="flex flex-wrap -m-4 text-center">
        <div class="p-4 w-1/3">
          <img class="w-1/3 mx-auto" src="https://racklog.cl/wp-content/uploads/2024/05/Diseno-de-sellos-negro-07-.png" alt="">
        </div>
        <div class="p-4 w-1/3">
          <img class="w-1/3 mx-auto" src="https://racklog.cl/wp-content/uploads/2024/05/Diseno-de-sellos-negro-08.png" alt="">
        </div>
        <div class="p-4 w-1/3">
          <img class="w-1/3 mx-auto" src="https://racklog.cl/wp-content/uploads/2024/05/Diseno-de-sellos-negro-09.png" alt="">
        </div>
    ...
    <div class="container px-5 py-24 mx-auto">
      <div class="flex flex-col">
        ...
        <div class="flex flex-wrap sm:flex-row flex-col py-6 mb-12">
          ...
          <p class="sm:w-3/5 leading-relaxed text-base sm:pl-10 pl-0">Estanterías Industriales de Alta Resistencia:
            Vigas y Bastidores de Acero para Máxima Capacidad de Carga</p>
        </div>
      </div>
